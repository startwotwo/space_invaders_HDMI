...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_SI {1} $axi_mem_intercon
...
\
  ...
  # Create instance: ps7_0_periph, and set properties
  set ps7_0_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 ps7_0_periph ]
  set_property -dict [list \
    CONFIG.NUM_MI {2} \
    CONFIG.NUM_SI {1} \
  ] $ps7_0_periph
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_periph_M00_AXI [get_bd_intf_pins ps7_0_periph/M00_AXI] [get_bd_intf_pins axi_vdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_periph_M01_AXI [get_bd_intf_pins ps7_0_periph/M01_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  ...
  connect_bd_net -net Net1  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins clk_wiz_0/clk_in1] \
  [get_bd_pins rst_100M/slowest_sync_clk] \
  [get_bd_pins axi_mem_intercon/aclk] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] \
  [get_bd_pins ps7_0_periph/aclk] \
  ...
  [get_bd_pins rst_100M/dcm_locked] \
  [get_bd_pins rst_pix/dcm_locked] \
  [get_bd_pins rgb2dvi_0/aRst_n]
  connect_bd_net -net rst_100M_peripheral_aresetn  [get_bd_pins rst_100M/peripheral_aresetn] \
  [get_bd_pins axi_mem_intercon/aresetn] \
  [get_bd_pins ps7_0_periph/aresetn] \
